"""time_tracker_18861 URL Configuration
...
admin.site.site_header = "Time-tracker"
admin.site.site_title = "Time-tracker Admin Portal"
admin.site.index_title = "Time-tracker Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version="v1",
        description="API documentation for Time-tracker App",
    ),
    public=True,
